...
import { AudioRefs, OscillatorPair } from '../../../hooks/types';
import { AUDIO_SETTINGS, PHRYGIAN_CHORDS, sliderToGain } from '../../../hooks/constants';
  ...
  const initializeAudio = useCallback(async () => {
    ...
    try {
      ...
      const oscillators: OscillatorPair[] = PHRYGIAN_CHORDS[0].map((note, i) => {
        ...
        // Detuned oscillator (sine wave instead of triangle)
